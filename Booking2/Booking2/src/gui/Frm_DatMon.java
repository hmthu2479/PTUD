...
public class Frm_DatMon extends JPanel {

    private Frm_DatMon_TableButton[] tables;

    public Frm_DatMon() {
        // Initialize tables
        tables = new Frm_DatMon_TableButton[40];
        ...
        for (int i = 0; i < 40; i++) {
            tables[i] = new Frm_DatMon_TableButton(i + 1, this);
        ...
        for (Frm_DatMon_TableButton table : tables) {
